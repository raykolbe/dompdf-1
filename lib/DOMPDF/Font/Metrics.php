...
class Metrics
{
     ...
     * @var array
     */
    protected static $_font_lookup = array();

    /**
     * Class initialization
     *
     */
    public static function init(Canvas $canvas = null)
    {
        if (!self::$_pdf) {
            if (!$canvas) {
     ...
     * @return float
     */
    public static function get_text_width($text, $font, $size, $word_spacing = 0.0, $char_spacing = 0.0)
    {
     ...
     * @return float
     */
    public static function get_font_height($font, $size)
    {
     ...
     * @return string
     */
    public static function get_font($family_raw, $subtype_raw = "normal")
    {
        static $cache = array();
    ...
    public static function get_family($family)
    {
     ...
     */
    public static function save_font_families()
    {
    ...
    public static function install_fonts($files)
    {
        $names = array();
    ...
    public static function set_font_family($fontname, $entry)
    {
        self::$_font_lookup[mb_strtolower($fontname)] = $entry;
    }

    public static function register_font($style, $remote_file)
    {
